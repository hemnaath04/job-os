    ...
    >
      ...
      >
        ...
        {wishlist.length > 0 ? (
          ...
          <div className="rounded-xl border border-dashed border-[color:var(--color-border)] px-4 py-5 text-center text-xs text-[color:var(--color-text-dim)]">
  ...
  return (
    ...
    >
      <div className="mb-3 flex items-center justify-between px-1">
        ...
        <span className="font-mono text-xs text-[color:var(--color-text-muted)]">{items.length}</span>
      </div>
    ...
    >
      <div className="flex items-start gap-2.5">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="truncate text-xs text-[color:var(--color-text-muted)]">{company}</div>
        </div>
      </div>
      {app.job.location && (
